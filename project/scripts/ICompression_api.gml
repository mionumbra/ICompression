...
/**
 * @func __ArchiveEntry_encode(_inst, _buffer, _offset, _where)
 ...
 * @ignore 
 */
function __ArchiveEntry_encode(_inst, _buffer, _offset, _where = _GMFUNCTION_)
{
...
/**
 * @func __ArchiveEntry_decode(_buffer, _offset)
 * @param {Id.Buffer} _buffer
 * @param {Real} _offset
 * @returns {Struct.ArchiveEntry} 
 * @ignore 
 */
function __ArchiveEntry_decode(_buffer, _offset)
{
    buffer_seek(_buffer, buffer_seek_start, _offset);
...
/**
 * @func __ExtractResult_encode(_inst, _buffer, _offset, _where)
 ...
 * @ignore 
 */
function __ExtractResult_encode(_inst, _buffer, _offset, _where = _GMFUNCTION_)
{
    buffer_seek(_buffer, buffer_seek_start, _offset);
    with (_inst)
    {
...
/**
 * @func __ExtractResult_decode(_buffer, _offset)
 * @param {Id.Buffer} _buffer
 * @param {Real} _offset
 * @returns {Struct.ExtractResult} 
 * @ignore 
 */
function __ExtractResult_decode(_buffer, _offset)
{
    buffer_seek(_buffer, buffer_seek_start, _offset);
...
/**
 * @func __CompressResult_encode(_inst, _buffer, _offset, _where)
 ...
 * @ignore 
 */
function __CompressResult_encode(_inst, _buffer, _offset, _where = _GMFUNCTION_)
{
    buffer_seek(_buffer, buffer_seek_start, _offset);
    with (_inst)
    {
...
/**
 * @func __CompressResult_decode(_buffer, _offset)
 * @param {Id.Buffer} _buffer
 * @param {Real} _offset
 * @returns {Struct.CompressResult} 
 * @ignore 
 */
function __CompressResult_decode(_buffer, _offset)
{
    buffer_seek(_buffer, buffer_seek_start, _offset);
...
function ic_compress(_data, _format, _level)
{
    ...
    buffer_write(__args_buffer, buffer_u64, _format);
    ...
    var _return_value = __ic_compress(buffer_get_address(__args_buffer), buffer_tell(__args_buffer));
...
function ic_decompress(_data, _format)
{
    ...
    var _return_value = __ic_decompress(buffer_get_address(__args_buffer), buffer_tell(__args_buffer));
...
function ic_compress_file(_src, _dst, _format, _level)
{
    ...
    buffer_write(__args_buffer, buffer_u32, string_byte_length(_src));
    buffer_write(__args_buffer, buffer_string, _src);

    // param: _dst, type: String
    if (!is_string(_dst)) show_error($"{_GMFUNCTION_} :: _dst expected string", true);
    buffer_write(__args_buffer, buffer_u32, string_byte_length(_dst));
    buffer_write(__args_buffer, buffer_string, _dst);
    ...
    var _return_value = __ic_compress_file(buffer_get_address(__args_buffer), buffer_tell(__args_buffer));
...
function ic_decompress_file(_src, _dst, _format)
{
    ...
    var _return_value = __ic_decompress_file(buffer_get_address(__args_buffer), buffer_tell(__args_buffer));
...
function ic_compress_buf(_input, _output, _format, _level)
{
    ...
    __ICompression_queue_buffer(buffer_get_address(_input), buffer_get_size(_input));

    // param: _output, type: Buffer
    if (!buffer_exists(_output)) show_error($"{_GMFUNCTION_} :: _output expected Id.Buffer", true);
    __ICompression_queue_buffer(buffer_get_address(_output), buffer_get_size(_output));
    ...
    var _return_value = __ic_compress_buf(buffer_get_address(__args_buffer), buffer_tell(__args_buffer), buffer_get_address(__ret_buffer), buffer_get_size(__ret_buffer));

    var _result = undefined;
    _result = __CompressResult_decode(__ret_buffer, buffer_tell(__ret_buffer));
    return _result;
}
...
function ic_decompress_buf(_input, _output, _format)
{
    ...
    var _return_value = __ic_decompress_buf(buffer_get_address(__args_buffer), buffer_tell(__args_buffer), buffer_get_address(__ret_buffer), buffer_get_size(__ret_buffer));
...
function ic_extract(_archive, _output_dir)
{
    ...
    var _return_value = __ic_extract(_archive, _output_dir, buffer_get_address(__ret_buffer), buffer_get_size(__ret_buffer));

    var _result = undefined;
    _result = __ExtractResult_decode(__ret_buffer, buffer_tell(__ret_buffer));
    return _result;
}
...
function ic_create(_archive, _format)
{
    ...
    buffer_write(__args_buffer, buffer_u32, string_byte_length(_archive));
    buffer_write(__args_buffer, buffer_string, _archive);
    ...
    var _return_value = __ic_create(buffer_get_address(__args_buffer), buffer_tell(__args_buffer));
...
function ic_detect(_data)
{
    ...
    __ICompression_queue_buffer(buffer_get_address(_data), buffer_get_size(_data));

    var __ret_buffer = __ext_core_get_ret_buffer();

    var _return_value = __ic_detect(buffer_get_address(__args_buffer), buffer_tell(__args_buffer), buffer_get_address(__ret_buffer), buffer_get_size(__ret_buffer));
...
function ic_detect_file(_path)
{
    ...
    var _return_value = __ic_detect_file(_path, buffer_get_address(__ret_buffer), buffer_get_size(__ret_buffer));
...
function ic_from_ext(_name)
{
    ...
    var _return_value = __ic_from_ext(_name, buffer_get_address(__ret_buffer), buffer_get_size(__ret_buffer));
...
function ic_to_str(_format)
{
    ...
    var _return_value = __ic_to_str(buffer_get_address(__args_buffer), buffer_tell(__args_buffer));

    return _return_value;
}

/// @ignore
function __ICompression_get_decoders()
{
    static __decoders = [
        __ArchiveEntry_decode,
        __ExtractResult_decode,
        __CompressResult_decode
    ];
    return __decoders;
}
